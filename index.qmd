...
citation:
  ...
  url: https://analyticalsciencejournals.onlinelibrary.wiley.com/doi/full/10.1002/nbm.70065
---
...
**RESULTS:** Average CBF and CMRO~2~ of cortical grey matter was `r round(allstats["GM_CBF","mean"],2)` ± `r round(allstats["GM_CBF","sd"],2)` mL / 100 g / min and `r round(allstats["GM_CMRO2","mean"],2)` ± `r round(allstats["GM_CMRO2","sd"],2)` µmol / 100 g / min, respectively. CMRO~2~ and CBF were positively correlated with days on non-invasive respiratory support, and negatively correlated with days in room air.
